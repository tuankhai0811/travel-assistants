package com.tuankhai.travelassistants.library.floatingsearchview.utils.view;
...
import com.tuankhai.travelassistants.library.floatingsearchview.utils.MenuPopupHelper;
...
public class MenuView extends LinearLayout {
    ...
    public void reset(int menu, int availWidth) {
        ...
        if (addOverflowAtTheEnd) {
            ...
            overflowAction.setImageResource(R.drawable.ic_more_vert_black);
