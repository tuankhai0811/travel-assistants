...
public class AddPlaceToScheduleDayRequest extends BasicRequest {
    public final String URL = "ScheduleDay/add/new";

    private String email, id_schedule, id_schedule_place, place_id;
    private int type;

    public AddPlaceToScheduleDayRequest(String email, String id_schedule, String id_schedule_place, String place_id, int type) {
        this.email = email;
